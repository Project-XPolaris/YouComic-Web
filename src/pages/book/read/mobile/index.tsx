...
interface ReadMobilePagePropsType {
  dispatch: Dispatch,
  bookRead: ReadPageModelStateType
  layout: LayoutModelStateType
}

function ReadMobilePage({ dispatch, bookRead, layout: { appBarHide } }: ReadMobilePagePropsType) {
...
export default connect(({ bookRead, layout }: ConnectType) => ({ bookRead, layout }))(ReadMobilePage);
